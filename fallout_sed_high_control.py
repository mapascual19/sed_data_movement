...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 18 13:28:32 2022
...
rows = np.loadtxt('control_case_zsmooth.csv', delimiter = ",")
rows = rows.transpose()
...
be = df.Constant(1e-8)         # Bedrock erosion coefficient, 4.8 +/- 2.66 mm/a  (Cowton et al., 2012) upper = 7.46, lower =  2.13999
cc = df.Constant(2e-11)        # Fluvial erosion coefficient, change order to 10-7 or 10-6 (Doyle et al., 2021)
# d = df.Constant(500.0)         # Fallout fraction, 12.3–44.8 m3 m−1 a−1(Knight et al., 2002; see table 4)
d = df.Constant(44.8)         # 12.3 = low, 44.8 = high 
...
#transpose dataframe
df_ice_vol.to_csv('D_high_control_case.csv', header=True)
